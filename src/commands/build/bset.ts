...
module.exports = {
	...
	async execute(client: Client, interaction: CommandInteraction) {
		...
		const lines = [
			`🔶🔶🔶🇧🇷 A build **${gameversion}** deve sair daqui a pouco. O jogo pode ficar indisponível até isso acontecer.`,
			`🔶🔶🔶🇺🇸 The build **${gameversion}** should be released soon. The game may be unavailable until this happens.`,
		];
